...
#ifndef HACKEDMODULES_ROUTING_DEBARATIAODV_DEBARATIAODV_H_
#define HACKEDMODULES_ROUTING_DEBARATIAODV_DEBARATIAODV_H_
...
class INET_API DebaratiAODV : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
  ...
  public:
    DebaratiAODV();
    virtual ~DebaratiAODV();
};


#endif /* HACKEDMODULES_ROUTING_DEBARATIAODV_DEBARATIAODV_H_ */
