...
#ifndef HACKEDMODULES_ROUTING_DEBARATIAODV_BH_DEBARATIAODV_BH_H_
#define HACKEDMODULES_ROUTING_DEBARATIAODV_BH_DEBARATIAODV_BH_H_
#include <map>
...
class INET_API DebaratiAODV_BH :public NTU_HackedModule, public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
private:
   // TrustScore   thomc
   int TrustScoreNira=0;

   NA_NesgLog log;
   /* Grayhole */
   bool grayholeAttackIsActive;
   double grayholeDroppingProbability;
...
//    double helloFlooingInterval;
//    double rreqFlooingInterval;
//    double dataFlooingInterval;
//    bool floodOnlyHello;
//    bool floodOnlyRred;
//    bool floodOnlyData;
...
//--------------------------------------------------thomc----------------------
  ...
  protected:
    ...
    //thomc: Cho thuat toan Debarati
     Ptr<Rrep> RR_Table[10000];
     L3Address srcAdr_RR_Table[10000];
     unsigned long numRrep;
     unsigned long DSNvsSSN =2000000;
     bool dichLaNodeLangGieng =false;
    //thomc end---------
  protected:
    ...
    void preHandleRREP(const Ptr<Rrep>& rrep, const L3Address& sourceAddr);
    void postHandleRREP(const Ptr<Rrep>& rrep, const L3Address& sourceAddr);
  ...
  public:
    DebaratiAODV_BH();
    virtual ~DebaratiAODV_BH();
};


#endif /* HACKEDMODULES_ROUTING_DEBARATIAODV_BH_DEBARATIAODV_BH_H_ */
