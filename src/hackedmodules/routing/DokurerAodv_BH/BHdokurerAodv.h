...
#ifndef HACKEDMODULES_ROUTING_DOKURERAODV_BH_BHDOKURERAODV_H_
#define HACKEDMODULES_ROUTING_DOKURERAODV_BH_BHDOKURERAODV_H_
...
class INET_API BHdokurerAodv : public NTU_HackedModule, public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
private:
    // TrustScore   thomc
...
protected:
    ...
    //thomc: Cho thuat toan Dokurer
    Ptr<Rrep> RR_Table[100];
    unsigned int numRrep;
    //thomc end---------
  ...
  public:
    BHdokurerAodv();
    virtual ~BHdokurerAodv();
};


#endif /* HACKEDMODULES_ROUTING_DOKURERAODV_BH_BHDOKURERAODV_H_ */
