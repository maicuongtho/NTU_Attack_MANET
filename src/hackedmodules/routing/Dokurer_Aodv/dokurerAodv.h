...
#ifndef HACKEDMODULES_ROUTING_DOKURER_AODV_DOKURERAODV_H_
#define HACKEDMODULES_ROUTING_DOKURER_AODV_DOKURERAODV_H_
...
class INET_API dokurerAodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
  ...
  protected:
    ...
    void handleOneRoundRrepTimeOutTimer();
...
#endif /* HACKEDMODULES_ROUTING_DOKURER_AODV_DOKURERAODV_H_ */
