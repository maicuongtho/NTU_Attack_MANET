...
#ifndef HACKEDMODULES_ROUTING_HHS_AODV_HHSAODV_H_
#define HACKEDMODULES_ROUTING_HHS_AODV_HHSAODV_H_
...
class INET_API hhsAodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
    ...
    //thomc
    bool firstRrep;  // to know if it is the second Route Reply
    Ptr<Rrep> lstRrep[100]; // to save all RRep, for check
...
#endif /* HACKEDMODULES_ROUTING_HHS_AODV_HHSAODV_H_ */
