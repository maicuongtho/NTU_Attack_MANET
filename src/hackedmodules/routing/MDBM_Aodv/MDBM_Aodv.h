...
#ifndef HACKEDMODULES_ROUTING_MDBM_AODV_MDBMAODV_H_
#define HACKEDMODULES_ROUTING_MDBM_AODV_MDBMAODV_H_
...
class INET_API MDBM_Aodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
    ...
    //---------------------------------------------------
    //thomc add
    simtime_t fakeRREQInterval;
    double ttlFakeRREQThreshold;
    //---------------------------------------------------
    ...
    simtime_t lastBroadcastTimeFakeRREQ;    // the last time when any control packet was broadcasted
    ...
    // thomc modifies
    cMessage *fakeRREQTimer = nullptr;   // timer to send fake RREQ (Bait time)
  ...
  protected:
    ...
    const Ptr<Rreq> createFakeRREQ(const L3Address& destAddr);
...
#endif /* HACKEDMODULES_ROUTING_MDBM_AODV_MDBMAODV_H_ */
