...
#ifndef HACKEDMODULES_ROUTING_NIRALIMODI_AODV_NIRAAODV_H_
#define HACKEDMODULES_ROUTING_NIRALIMODI_AODV_NIRAAODV_H_
...
class INET_API niraAodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
...
#endif /* HACKEDMODULES_ROUTING_NIRALIMODI_AODV_NIRAAODV_H_ */
