...
#ifndef HACKEDMODULES_ROUTING_RREPAUTH_AODV_RREPAUTHAODV_H_
#define HACKEDMODULES_ROUTING_RREPAUTH_AODV_RREPAUTHAODV_H_
...
/*
 * This class implements RrepAuthAODV routing protocol and Netfilter hooks
 * in the IP-layer required by this protocol.
 */

class INET_API RrepAuthAodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
  protected:
    /*
    ...
    //thomc
        int modulo_n = 0;     // n=p*q; p,q là hai số nguyên tố
        int publickey_e= 0;   // Khóa công khai, dùng để xác thực thông tin
        int privatekey_d=0;   // Khóa bí mật, dùng để mã hóa địa chỉ IP

  protected:
    int modulo(long x, int n);
...
#endif /* HACKEDMODULES_ROUTING_RREPAUTH_AODV_RREPAUTHAODV_H_ */
