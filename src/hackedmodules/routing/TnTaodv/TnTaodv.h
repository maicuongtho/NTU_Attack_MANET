...
#ifndef HACKEDMODULES_ROUTING_TNTAODV_TNTAODV_H_
#define HACKEDMODULES_ROUTING_TNTAODV_TNTAODV_H_
...
class INET_API TnTaodv : public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
private:
...
protected:
    ...
    std::map<RreqIdentifier, simtime_t> rreqsLastBroadcastTime;  //thomc
...
#endif /* HACKEDMODULES_ROUTING_TNTAODV_TNTAODV_H_ */
