...
#ifndef HACKEDMODULES_ROUTING_TNTAODV_BH_TNTAODV_BH_H_
#define HACKEDMODULES_ROUTING_TNTAODV_BH_TNTAODV_BH_H_
...
class INET_API TnTaodv_BH : public NTU_HackedModule, public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
    std::map<L3Address, unsigned int> numRREQ_forwarded;
    std::map<L3Address, unsigned int> numRREQ_received;
private:
...
protected:
  ...
  public:
    ...
    virtual ~TnTaodv_BH();
  // Hack
  //void PrintOutmyRoutingTable();
  //double Theshold; //Trung binh do lech DSN hien tai, so vo ca DSN co trong bang dinh tuyen
  //double SafeLevel;
...
#endif /* HACKEDMODULES_ROUTING_TNTAODV_BH_TNTAODV_BH_H_ */
