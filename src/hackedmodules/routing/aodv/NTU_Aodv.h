...
class INET_API NTU_Aodv : public NTU_HackedModule, public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
    private:
    // TrustScore   thomc
...
//--------------------------------------------------thomc----------------------
  ...
  protected:
    ...
    IRoute *createRouteWired(const L3Address& destAddr, const L3Address& nextHop, unsigned int hopCount, bool hasValidDestNum, unsigned int destSeqNum, bool isActive, simtime_t lifeTime);
