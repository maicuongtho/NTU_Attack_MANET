...
class INET_API floodNTU_Aodv : public NTU_HackedModule, public RoutingProtocolBase, public NetfilterBase::HookBase, public UdpSocket::ICallback, public cListener
{
private:
    NA_NesgLog log;
...
//--------------------------------------------------thomc----------------------
  protected:
    ...
    cMessage *rreqFloodingTimer = nullptr;    // timer to send RREQ for flooding attack //thomc
    // lifecycle
  ...
  protected:
    ...
    void sendFakeRREQ(const Ptr<Rreq>& rreq, const L3Address& destAddr, unsigned int timeToLive);
